...
function Checkout({ className }: CheckoutProps) {
  ...
  return (
      <div className={clsx('checkout pt-[56px] fixed w-full h-full z-10 flex bg-[#E5E5E5] mx-auto justify-center', className) }>
        <div className={'shipping display block'}>
          <div className={'shipping-address w-[871px] h-[230px] relative bg-white rounded-xl p-4'}>
            ...
            <button className={'change-btn absolute right-[24px] top-[86px] p-2 border-2 border-[#1A1F16] rounded-[11px] w-[98px] text-[#1A1F16] text-base'}>Change</button>
          </div>
          ...
          <div className={'payment-method w-[871px] h-[214px] relative bg-white rounded-xl p-4 mt-6'}>
            <div className={'wrapper'}>
              ...
              <div className={'mastercard flex mt-4'}>
                ...
                <div className={'mastercard text-xl mr-1'}>Mastercard</div> <div className={'mastercard-ending text-xl text-[#60695C]'}>ending in {'1252'}</div>
              </div>

              <div className={'gift-card-balance flex mt-2'}>
                <img className={'mr-2'} src={giftIcon} alt={'gift-card-icon'}/>
                <div className={'balance text-xl mr-1'}>$ {'53.21'}</div> <div className={'gift-card-balance text-xl text-[#60695C]'}>gift card balance</div>
              </div>
        ...
        <div className={'order-wrapper'}>
          <div className={'order-sum w-60 h-[360px] bg-white ml-[102px] rounded-xl p-4'}>
            ...
            <div className={'text-wrapper flex mt-4 justify-between'}>
              ...
              <div className={'spipping-price text-[#60695C] text-base'}>${'6.99'}</div>
            </div>
          ...
          <div className={'flex justify-end'}>
            <button className="p-2 border-2 w-[111px] border-[#1A1F16] rounded-[11px] text-[#1A1F16] text-base relative pl-[38px] mt-[35px]">Back
