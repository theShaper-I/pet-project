      ...
      <div className={'shipping-address w-[676px] h-[658px] relative bg-white rounded-xl p-8'}>
        <div className={'wrapper'}>
          ...
          <div className={'input-wrap w-[612px] h-28 mt-6'}>
            <div className={'card-holder-name text-base mt-2 pl-2 font-normal text-[#1A1F1680]'}>
              Cardholder Name
            </div>
            <input
              className={
          ...
          <div className={'input-wrap w-[612px] h-28 mt-4'}>
            <div className={'card-number text-base mt-2 pl-2 font-normal text-[#1A1F1680]'}>
              Card Number
            </div>
            <input
              className={
        ...
        <div className={'block button wrapper relative mt-8'}>
          ...
          <input
            className={
              'block text-xl w-[580px] h-[40px] bg-[#1A1F16] text-white rounded-[10px] mx-auto'
            }
            type={'submit'}
