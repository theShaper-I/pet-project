...
const ProductItem: FC<ProductItemProps> = ({ product, handleOpenProductPage, handleAddToCart }) => (
  ...
  >
    <div
      ...
      className={clsx(
        product.type === ProductType.Phone &&
          'image-bg w-[190px] h-[232px] bg-white rounded-3xl cursor-pointer ',
        product.type === ProductType.Watch &&
          'image-bg w-[190px] h-[232px] bg-white rounded-3xl cursor-pointer',
        product.type === ProductType.Headphones &&
          'image-bg w-[190px] h-[232px] bg-white rounded-3xl cursor-pointer',
        product.type === ProductType.Laptop &&
          'image-bg w-[427px] h-[232px] bg-white rounded-3xl cursor-pointer',
      )}
    >
      <img
    ...
    <div className='title pl-2 pt-4 text-[#1A1F16] text-xl font-medium whitespace-nowrap'>
